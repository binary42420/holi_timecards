# Deploy Persistent Session Management System
...
# Deploy backend with enhanced environment variables
gcloud run deploy $SERVICE_PREFIX-backend `
    ...
    --set-env-vars "DB_USER=holitimecards_main" `
    --set-env-vars "DB_NAME=holitimecards_main" `
    --set-env-vars "REDIS_HOST=redis-10534.c1.us-central1-2.gce.redns.redis-cloud.com" `
    --set-env-vars "REDIS_PORT=10534" `
    ...
    --set-secrets "CSRF_SECRET_KEY=csrf-secret:latest"
